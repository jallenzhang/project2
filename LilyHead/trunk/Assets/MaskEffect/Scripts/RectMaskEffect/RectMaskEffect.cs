...
public class RectMaskEffect : MaskEffect
{
    ...
    private void ResetVertices()
    {
		if(reverse)
		{
	        ...
	        arrVertices[2].pos = new Vector3( 0.0f, halfHeight, 0.0f );
	        arrVertices[3].pos = new Vector3( 0.0f, halfHeight, 0.0f );
	        arrVertices[4].pos = new Vector3( 0.0f, halfHeight, 0.0f );
	        arrVertices[5].pos = new Vector3( 0.0f, halfHeight, 0.0f );
	        arrVertices[6].pos = new Vector3( 0.0f, halfHeight, 0.0f );
	        arrVertices[7].pos = new Vector3( 0.0f, halfHeight, 0.0f );
	        arrVertices[8].pos = new Vector3( 0.0f, halfHeight, 0.0f );
