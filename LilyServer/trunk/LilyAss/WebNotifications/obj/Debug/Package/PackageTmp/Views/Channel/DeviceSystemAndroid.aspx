<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PagedList<WebNotifications.Models.DeviceSystemObj>>" %>
...
<h2> 渠道--Android系统查询</h2>
<% using (Html.BeginForm(new { Action = "DeviceSystemAndroidSearch" }))
     { %>        
        <p><label>时间(2011/7/8):&nbsp;</label><%=Html.TextBox("tbFilterTime")%>
        </p>
        <input type="submit" value="查询" onclick='this.form.action="<%=Url.Action("DeviceSystemAndroidSearch")%>"' />               
<% } %>
