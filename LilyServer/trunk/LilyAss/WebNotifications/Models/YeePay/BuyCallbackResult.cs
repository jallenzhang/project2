...
namespace WebNotifications.Models.YeePay
{
    [Serializable]
    ...
    public class BuyCallbackResult
    {
        ...
        {
            string myStrFormat = "p1_MerId={0}&r0_Cmd={1}&r1_Code={2}&r2_TrxId={3}&r3_Amt={4}&r4_Cur={5}&r5_Pid={6}&r6_Order={7}&r7_Uid={8}&r8_MP={9}&r9_BType={10}&rp_PayDate={11}&hmac={12}&errMsg={13}";
            
            string result = string.Format(myStrFormat, p1_MerId, r0_Cmd, r1_Code, r2_TrxId, r3_Amt, r4_Cur, r5_Pid, r6_Order,r7_Uid, r8_MP, r9_BType, rp_PayDate, hmac, errMsg);
