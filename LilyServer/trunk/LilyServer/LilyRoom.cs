...
namespace LilyServer
{
    ...
    /// </summary>
    public class LilyRoom : LiteLobbyRoom
    {
        ...
        /// Name of the lobby.
        /// </param>
        public LilyRoom(string lobbyName)
            : base(lobbyName)
        {            
            // 使用父类的对象
        ...
        /// The new actor
        /// </returns>
        protected override Actor HandleJoinOperation(LitePeer peer, JoinRequest joinRequest, SendParameters sendParameters)
        {
            if (this.IsDisposed)
            {
            ...
            peer.SendOperationResponse(new OperationResponse(joinRequest.OperationRequest.OperationCode, parameters), sendParameters);
