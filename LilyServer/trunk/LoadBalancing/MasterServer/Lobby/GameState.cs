...
namespace Photon.LoadBalancing.MasterServer.Lobby
{
    ...
    public class GameState
    {
        ...
        public readonly Dictionary<string, PeerState> peerDict = new Dictionary<string, PeerState>();
        ...
        {
            return peer.NetworkProtocol == NetworkProtocolType.Tcp ? this.GameServer.TcpAddress : this.GameServer.UdpAddress;
        }
        ...
        public bool TrySetProperties(Hashtable props, out bool changed, out string debugMessage)
        {
            ...
            if (props.ContainsKey((byte)GameParameter.IsVisible))
            {
                ...
                if (!(value is bool))
                {
                    debugMessage = "Invalid parameter type for 'isVisible'.";
                    return false;
                }
            ...
            if (props.ContainsKey((byte)GameParameter.IsOpen))
            {
                ...
                if (!(value is bool))
                {
                    debugMessage = "Invalid parameter type for 'isOpen'.";
                    return false;
                }
            ...
            if (props.ContainsKey((byte)GameParameter.MaxPlayer))
            {
                ...
                if (!(value is byte))
                {
                    debugMessage = "Invalid parameter type for 'maxPlayer'.";
                    return false;
                }
