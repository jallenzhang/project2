...
namespace Photon.LoadBalancing.MasterServer
{
    ...
    public class MasterApplication : NodeResolverBase
    {
        ...
        protected virtual void Initialize()
        {
            ...
            this.Lobby = new LilyAppLobby(this.LoadBalancer);
        ...
        protected override void Setup()
        {
            ...
            LilyServer.AchievementManager.Singleton.LoadFile(this.BinaryPath + "/Resources/Achievement.xml");
            LilyServer.AwardManager.Singleton.LoadFile(this.BinaryPath + "/Resources/Awards.xml");
            LilyServer.GiftManager.Singleton.LoadFile(this.BinaryPath + "/Resources/Gifts.xml");

            //LilyServer.Helper.WordsFilter.path = this.BinaryPath;
            this.Initialize();
            LilyServer.LilyServer.Actors = new Lite.ActorCollection();
            LilyServer.LilyServer.BinaryPathLily = this.BinaryPath;
        }
